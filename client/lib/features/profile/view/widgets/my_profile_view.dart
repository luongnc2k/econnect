...
class _MyProfileViewState extends ConsumerState<MyProfileView> {
  ...
  Future<void> _uploadAvatar() async {
    final success = await ref
        ...
        .uploadMyAvatar('/fake/path/avatar.png'); // Simulate file path
  ...
  Widget build(BuildContext context) {
    ...
    if (profile == null) {
      return Center(
        child: Text(
          state.errorMessage ?? 'Không có dữ liệu hồ sơ',
        ),
      );
    }
        ...
        children: [
          ...
          ProfileInfoCard(
            ...
            items: [
              ...
              ProfileInfoItem(
                label: 'Trạng thái',
                value: profile.isActive ? 'Đang hoạt động' : 'Ngưng hoạt động',
              ),
              ProfileInfoItem(
