      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Theo dõi các lớp bạn phụ trách và xem lại lịch đã dạy theo tuần hoặc tháng.',
  ...
  Widget _buildBody(
    ...
    if (sourceClasses.isEmpty) {
      return _EmptyTutorSchedule(
        ...
        title: _showPast ? 'Chưa có lớp đã dạy' : 'Chưa có lớp sắp dạy',
        message: _showPast
            ? 'Các lớp đã hoàn thành sẽ xuất hiện tại đây.'
            : 'Khi bạn tạo lớp mới, lớp sắp dạy sẽ xuất hiện tại đây.',
      );
    }

    if (selectedClasses.isEmpty) {
      return const _EmptyTutorSchedule(
        icon: Icons.event_available_outlined,
        title: 'Ngày này chưa có lịch dạy',
        message: 'Chọn ngày có đánh dấu đỏ để xem danh sách lớp.',
      );
    }
